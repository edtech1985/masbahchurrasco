...
import { Container, Location, Paragraph, Title } from "./Place";

export default function Place() {
  return (
    <Container>
    <Title>Sabores em Dobro: Duas Unidades, Uma Experiência Inigualável!</Title>
    <Title>Descubra o Mundo do Churrasco no MasBah! Churrasco</Title>
    <Paragraph>
    ...
    <Paragraph>
      Localizada na Rua Sabino Anisio da Silveira, 116 - Silveira, 116 - Campeche, nossa unidade no Campeche é o local ideal para saborear deliciosos petiscos e sanduíches de churrasco. Aberta de segunda a sábado, das 19h às 23h, estamos prontos para oferecer a você uma experiência gastronômica única e inesquecível.
    </Paragraph>
    <Location>
      Telefone para contato (Campeche): (48) 99133-8844
    </Location>
    <Location>
      Unidade Carvoeira
    </Location>
    ...
    <Location>
      Telefone para contato (Carvoeira): (48) 99833-3303
    </Location>
    <Paragraph>
