...
import { Container, Location, Paragraph, Title } from "./Home";

export default function Home() {
  return (
    <Container>
      <Title>MásBah! Churrasco: A Arte do Churrasco sobre Rodas</Title>
      <Location>
      ...
      <Paragraph>
        Na Praia do Campeche e na Carvoeira, você encontra o MásBah! Churrasco, o novo ícone da gastronomia local. Com paixão pelo churrasco tradicional e autêntico, trazemos até você uma experiência única que une a conveniência da churrasqueira e forno sobre rodas à qualidade dos nossos petiscos e sanduíches de churrasco com molhos artesanais.
      </Paragraph>
      <Paragraph>
        O MásBah! Churrasco é a escolha perfeita para quem busca o verdadeiro sabor do churrasco, em qualquer momento e em qualquer lugar.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        Venha conhecer o MásBah! Churrasco e descubra o segredo por trás dos melhores rangos da cidade. Esperamos por você!
      </Paragraph>
    </Container>
  );
}